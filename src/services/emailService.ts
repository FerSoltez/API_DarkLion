 ...
 */
export async function sendDesignConfirmationEmail(data: ConfirmationEmailData): Promise<void> {
  try {
    ...
    console.error('❌ Error enviando correo de confirmación:', (error as Error).message);
    throw error;
  }
}
